...
type DAODescribeProcesdaoProps = Omit<
...
const DAODescribeProcesdao: React.FC<DAODescribeProcesdaoProps> = (props) => {
  return (
    <>
...
DAODescribeProcesdao.defaultProps = {
...
export default DAODescribeProcesdao;
