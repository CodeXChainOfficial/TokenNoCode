        ...
        <div className="flex flex-col gap-8 items-center w-full">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] md:px-10 px-20 sm:px-5 w-full">
            <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-[401px] sm:w-full">
              ...
              <div
                className="common-pointer bg-black-900_01 border-blue-400 border-l-[10px] border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full"
                onClick={() => navigate("/forumcodexeducation")}
              >
              ...
              >
                <div
                  className="common-pointer bg-black-900_01 border-l-[10px] border-orange-300 border-solid flex flex-1 flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full"
                  onClick={() => navigate("/forumcodexprojects")}
                >
                  <div className="flex flex-row items-center justify-between w-full">
                ...
                <div
                  className="common-pointer bg-black-900_01 border-l-[10px] border-pink-300 border-solid flex flex-1 flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full"
                  onClick={() => navigate("/forumcodexsuggestion")}
                >
                  <div className="flex flex-row items-center justify-between w-full">
                ...
                <div
                  className="common-pointer bg-black-900_01 border-deep_purple-A200 border-l-[10px] border-solid flex flex-1 flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full"
                  onClick={() => navigate("/forumcodexprojectsone")}
                >
                  <div className="flex flex-row gap-4 items-center justify-between w-full">
                ...
                <div
                  className="common-pointer bg-black-900_01 border-green-400 border-l-[10px] border-solid flex flex-1 flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full"
                  onClick={() => navigate("/forumcodexdevelopment")}
                >
                  <div className="flex flex-row items-center justify-between w-full">
